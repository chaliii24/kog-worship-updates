...
export default function TemplateNameModal({ C, ACCENT, value, setValue, onCancel, onConfirm }) {
  return (
    <motion.div {...modalOverlay} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 9999 }}>
      <motion.div {...modalPanel} style={{ background: C.panel, border: '1px solid #2d2d3f', borderRadius: '14px', width: '380px', maxWidth: '92vw', padding: '22px', boxSizing: 'border-box' }}>
        ...
        <input
          ...
          autoFocus
          style={{ width: '100%', background: C.elevated2, border: '1px solid #2d2d3f', borderRadius: '8px', padding: '10px', color: C.text, fontSize: '14px', outline: 'none', marginBottom: '20px' }}
        />
